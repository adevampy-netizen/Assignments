...
// 10.
// Current year: 2023 @ doubt
var today= new Date() 
const currentYear:number=today.getFullYear()
console.log("Current year:" + currentYear )
let cYear:number=2023
console.log(` or Current year:${cYear}` )
// 11.
// Number of followers on a social media platform: 1,000, @doubt
